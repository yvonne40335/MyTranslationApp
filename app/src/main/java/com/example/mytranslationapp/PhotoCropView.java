...
public class PhotoCropView extends View {
    ...
    private static final int minWidth = 40;/*the minimum width of 裁剪框*/
    private static final int minHeight = 80;/*the minimum height of 裁剪框*/

    private static final int START_X = 300; //裁剪框開始位置
    ...
    private int coverHeight = 120;/*height of selection box*/

    private Paint mPaint;
    private Paint mPaintLine;
    private Bitmap mBitmapCover;//黑色遮罩
    private Bitmap mBitmapRectBlack;//裁剪框
    ...
    private void init() {
        ...
        int width = manager.getDefaultDisplay().getWidth(); //找出螢幕的長寬,計算遮罩大小
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setXfermode(xfermode);//使裁剪框可在遮罩之上
        canvas.drawBitmap(mBitmapRectBlack, sX, sY, mPaint);
        if (locationListener != null) { //設listener
